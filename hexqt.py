...
class InputDialogue(QInputDialog):
    ...
    def init_ui(self):
        dialogue_response, dialogue_complete = QInputDialog.getText(self, self.dialogueTitle, self.dialogueText,
                                                                   QLineEdit.Normal, '')

        if dialogue_complete and dialogue_response:
            self.dialogue_response = dialogue_response
...
class App(QMainWindow):
    ...
    def highlightMain(self):
        ...
        totalBytes = totalBytes // self.byteWidth
        asciiStart = asciiStart // self.byteWidth
    ...
    def offsetJump(self):
        jumpText = InputDialogue('Jump to Offset', 'Offset').dialogue_response
        jumpOffset = 0xF
    ...
    def createMainView(self):
        ...
        # Syncing scrolls.
        self.syncScrolls(self.mainTextArea, self.asciiTextArea, self.offsetTextArea)
